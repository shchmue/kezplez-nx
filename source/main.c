...
//Credit for 6.0.0 keyblob_05 goes to ThatNerdyPikachu via hekate (https://github.com/CTCaer/hekate/commit/4e43bd9a396a6a65f2811d0525ed314166f00516#diff-596ed8c86ddb08a656d2b33fd3739e3b)
//As of right now, only 0 - 5 are used but there will be more in future firmwares
...
void find_hekate_dumps()
{
	...
	while ((ent = readdir(dir)))
	{
		...
		else if (strtoul(ent->d_name, NULL, 16) > 0) // /backup/<eMMC serial> post-hekate 4.0
		{
			strcat(dirname, "/");
